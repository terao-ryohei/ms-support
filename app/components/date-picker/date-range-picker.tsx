...
const formatDate = (date: Date, locale?: string): string => {
  return date.toLocaleDateString(locale ?? "ja-JP", {
    month: "short",
    day: "numeric",
    year: "numeric",
  });
  ...
  return (
    ...
    >
      ...
      <PopoverContent align={align} className="w-auto">
        {!isSmallScreen && (
          <div className="flex w-full items-end gap-1 pr-2 pb-2 pl-6">
            {PRESETS.map((preset) => (
              <PresetButton
                key={preset.name}
                preset={preset.name}
        ...
        <div className="flex py-2">
          <div className="flex">
            <div className="flex flex-col">
              <div className="mb-2 flex flex-col items-center justify-center gap-2 px-3 pb-4 lg:flex-row lg:items-start lg:pb-0">
                {showCompare && (
